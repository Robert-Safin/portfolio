...
const HomePage = () => {
  ...
  const resetBackgroundColor = () => [setBackgroundColor("rgba(20,20,20,1)")];
  return (
    <div className={styles.split}>
      ...
      <div
        ...
        style={{ background: backgroundColor, transitionDuration: "1s" }}
      >
        <div className={styles.fade}>
            ...
            <div className={styles.contacts}>
              ...
              <Link href={`CV EN.pdf`} target="_blank">
                <div className={styles.contactItem}>
                  ...
                  <p className={styles.contactText}>Resume</p>{" "}
                </div>
              </Link>
            </div>
          </div>
          ...
          <div className={styles.cards}>
            <div className={styles.projectsContainer}>
              ...
              <div className={styles.projectCards}>
                ...
                />
                <ProjectCard
                  imageSrc={`/Space-Trip.png`}
                  title="Space-Trip"
                  handleBackgroundColorChange={handleBackgroundColorChange}
                  resetBackgroundColor={resetBackgroundColor}
                  color={"rgba(0,10,40,1)"}
                />
                <ProjectCard
              ...
              <div className={styles.technologyGroup}>
                ...
                <TechnologyCard
                  icon={
                    <DiRubyRough
                      className={styles.techIcon}
                      style={{ color: "rgb(160, 40, 20)" }}
                    />
                  }
                  name={"Ruby"}
                  handleBackgroundColorChange={handleBackgroundColorChange}
                  resetBackgroundColor={resetBackgroundColor}
                  color={"rgba(40,10,5,1)"}
                />
                <TechnologyCard
                  icon={
                    <IoLogoJavascript
                      className={styles.techIcon}
                      style={{ color: "rgb(224, 209, 99)" }}
                    />
                  }
                  name={"JavaScript"}
                  handleBackgroundColorChange={handleBackgroundColorChange}
                  resetBackgroundColor={resetBackgroundColor}
                  color={"rgba(40,35,20,1)"}
                />
                <TechnologyCard
                  icon={
                    <SiHtml5
                      className={styles.techIcon}
                      style={{ color: "rgb(210, 85, 50)" }}
                    />
                  }
                  name={"HTML"}
                  handleBackgroundColorChange={handleBackgroundColorChange}
                  resetBackgroundColor={resetBackgroundColor}
                  color={"rgba(40,20,10,1)"}
                />
                <TechnologyCard
                  icon={
                    <SiCss3
                      className={styles.techIcon}
                      style={{ color: "rgb(50, 70, 210)" }}
                    />
                  }
                  name={"CSS"}
                  handleBackgroundColorChange={handleBackgroundColorChange}
                  resetBackgroundColor={resetBackgroundColor}
                  color={"rgba(10,10,40,1)"}
                />
              </div>
              ...
              <div className={styles.technologyGroup}>
                ...
                <TechnologyCard
                  icon={
                    <SiSqlite
                      className={styles.techIcon}
                      style={{ color: "rgb(129, 177, 219)" }}
                    />
                  }
                  name={"SQLite"}
                  handleBackgroundColorChange={handleBackgroundColorChange}
                  resetBackgroundColor={resetBackgroundColor}
                  color={"rgba(15,25,35,1)"}
                />
                <TechnologyCard
                  icon={
                    <SiPrisma
                      className={styles.techIcon}
                      style={{ color: "rgb(24, 49, 69)" }}
                    />
                  }
                  name={"Prisma"}
                  handleBackgroundColorChange={handleBackgroundColorChange}
                ...
                <TechnologyCard
                  ...
                  handleBackgroundColorChange={handleBackgroundColorChange}
                  resetBackgroundColor={resetBackgroundColor}
                  color={"rgba(10,20,15,1)"}
                />
                <TechnologyCard
                  icon={
                    <DiMongodb
                      className={styles.techIcon}
                      style={{ color: "rgb(64, 137, 82)" }}
                    />
                  }
                  name={"MongoAtlas"}
                  handleBackgroundColorChange={handleBackgroundColorChange}
                  resetBackgroundColor={resetBackgroundColor}
                  color={"rgba(20,30,25,1)"}
                />
                <TechnologyCard
                  icon={
                    <IoMdMap
          ...
          <div className={styles.miscGroup}>
            ...
            <EducationCard
              ...
              location="Le Wagon, Bali"
            />
            <EducationCard
              year={"2020"}
              title="MS REAL ESTATE DEVELOPMENT"
              location="University of Westminster, London"
            />
            <EducationCard
              year={"2019"}
              title="BA INTERNATIONAL BUSINESS (SPANISH)"
              location="University of Westminster, London"
            />
          </div>
          ...
          <div className={styles.miscGroup}>
            ...
            <EducationCard
              year={"2022-2023"}
              title="Economist at a Petroleum Company"
